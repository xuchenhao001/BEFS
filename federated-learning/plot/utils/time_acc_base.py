...
def plot_time_acc(title, fed_sync_sgd_1, fed_sync_sgd_01, fed_sync_sgd_001, fed_sync_sgd_0001, fed_sync, fed_avg, save_path=None, plot_size="L"):
    ...
    axes.plot(x, fed_sync_sgd_001, label="BEFS lr=0.001", linewidth=1)
    axes.plot(x, fed_sync_sgd_0001, label="BEFS lr=0.0001", linewidth=1)
